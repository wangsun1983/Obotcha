 ...
 *
 * DO NOT INCLUDE THIS FILE DIRECTLY; include connection_base instead.
 *
 ...
 * transaction classes (see transaction_base.hxx) or preferably the
 * transactor framework (see transactor.hxx).
 *
