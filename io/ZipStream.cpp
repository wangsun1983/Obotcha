...
int _ZipStream::do_extract_currentfile(unzFile uf,char *dest,const int* popt_extract_without_path,
    ...
    else
    {
        ...
        //printf("unzOpenCurrentFilePassword,password is %s \n",password);
...
/*
int _ZipStream::do_extract_onefile(unzFile uf,const char* filename,int opt_extract_without_path,
