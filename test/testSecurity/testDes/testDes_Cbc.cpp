...
int test_des_cbc() {
    ...
    while(1) {
        ...
        if(t1 == nullptr) {
            printf("---[TestDesCbc Test {encrypt(String)/decrypt(String)} case1] [FAILED]--- \n");
            break;
        }
        String t2 = des->decrypt(t1);
        if(t2 == nullptr) {
            printf("---[TestDesCbc Test {encrypt(String)/decrypt(String)} case2] [FAILED]--- \n");
            break;
        }

        if(!t2->equals("hello world")) {
            printf("---[TestDesCbc Test {encrypt(String)/decrypt(String)} case3] [FAILED]--- \n");
            break;
        }

        printf("---[TestDesCbc Test {encrypt(String)/decrypt(String)} case4] [Sucess]--- \n");
        break;
    }
    ...
    while(1) {
        ...
        if(t1 == nullptr) {
            printf("---[TestDesCbc Test {encrypt(ByteArray)/ decrypt(ByteArray)} case1] [FAILED]--- \n");
            break;
        }

        ByteArray t2 = des->decrypt(t1);
        if(t2 == nullptr) {
            printf("---[TestDesCbc Test {encrypt(ByteArray)/ decrypt(ByteArray)} case2] [FAILED]--- \n");
            break;
        }

        for(int i = 0;i<128;i++) {
            if(t2->at(i) != data->at(i)) {
                printf("---[TestDesCbc Test {encrypt(ByteArray)/ decrypt(ByteArray)} case3] [FAILED]--- \n");
                break;
            }
        }

        printf("---[TestDesCbc Test {encrypt(ByteArray)/decrypt(ByteArray)} case4] [Sucess]--- \n");
        break;
    }
    ...
    while(1) {
        ...
        if(!encryptfile->exists()) {
            printf("---[TestDesCbc Test {encrypt(File,File)/ decrypt(File,File)} case1] [FAILED]--- \n");
            break;
        }
        ...
        if(!decryptfile->exists()) {
            printf("---[TestDesCbc Test {encrypt(File,File)/ decrypt(File,File)} case2] [FAILED]--- \n");
            break;
        }
        ...
        if(arr1->size() != arr2->size()) {
            ...
            printf("---[TestDesCbc Test {encrypt(File,File)/ decrypt(File,File)} case3] [FAILED]--- \n");
            break;
        }

        for(int i = 0;i<arr1->size();i++) {
            if(arr1->at(i) != arr2->at(i)) {
                printf("---[TestDesCbc Test {encrypt(File,File)/ decrypt(File,File)} case4] [FAILED]--- \n");
                break;
            }
        }

        printf("---[TestDesCbc Test {encrypt(File,File)/ decrypt(File,File)} case5] [Success]--- \n");
        break;
    }
}
