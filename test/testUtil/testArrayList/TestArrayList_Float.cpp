...
void testArrayList_Float() {
  ...
  while(1) {
    ...
    while(iterator->hasValue()) {
      if(st(Math)::compareFloat(iterator->getValue()->toValue(),3.1f) == st(Math)::AlmostEqual) {
        iterator->remove();
      }else {
        iterator->next();
      }
    ...
    if(st(Math)::compareFloat(list->get(0)->toValue(),1.1f) != st(Math)::AlmostEqual
      ||st(Math)::compareFloat(list->get(1)->toValue(),2.1f) != st(Math)::AlmostEqual
      ||st(Math)::compareFloat(list->get(2)->toValue(),4.1f) != st(Math)::AlmostEqual
      ||st(Math)::compareFloat(list->get(3)->toValue(),5.1f) != st(Math)::AlmostEqual) {
