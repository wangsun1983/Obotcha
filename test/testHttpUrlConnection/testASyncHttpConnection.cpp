...
DECLARE_SIMPLE_CLASS(Listener) IMPLEMENTS(HttpConnectionListener) {
...
int testAsyncHttpConnection() {
    ...
    HttpUrlConnection connection = pool->createConnection(url);
    connection->setListener(createListener());
