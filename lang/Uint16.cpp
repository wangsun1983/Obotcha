...
void _Uint16::update(sp<_Uint16> v) {
    if(v == nullptr) {
        throw NullPointerException("Uint16 update nullptr");
    }
...
uint16_t _Uint16::parseDecUint16(sp<_String> v) {
    if(v == nullptr) {
        throw NullPointerException("parseDecUint16 nullptr");
    }
...
uint16_t _Uint16::parseHexUint16(sp<_String> v) {
    if(v == nullptr) {
        throw NullPointerException("parseHexUint16 nullptr");
    }
...
uint16_t _Uint16::parseOctUint16(sp<_String> v) {
    if(v == nullptr) {
        throw NullPointerException("parseOctUint16 nullptr");
    }
...
uint16_t _Uint16::parseBinaryUint16(sp<_String> v) {
    if(v == nullptr) {
        throw NullPointerException("parseBinaryUint16 nullptr");
    }
