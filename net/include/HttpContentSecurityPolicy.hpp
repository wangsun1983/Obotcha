...
DECLARE_CLASS(HttpContentSecurityPolicyItem) {
public:
    _HttpContentSecurityPolicyItem();
    int command;
    ArrayList<Integer> rules;
    ArrayList<String> sources;
};

DECLARE_CLASS(HttpContentSecurityPolicy) {

public:
    _HttpContentSecurityPolicy();
    _HttpContentSecurityPolicy(String);

    void import(String);
    ArrayList<HttpContentSecurityPolicyItem> get();
...
private:
    ...
    ArrayList<HttpContentSecurityPolicyItem> items;
