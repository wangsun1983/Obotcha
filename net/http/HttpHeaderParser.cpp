...
String _HttpHeaderParser::headerString[Http_Header_MAX] = {
    createString("Authority"),
    createString("Method"),
    createString("Path"),
    createString("Scheme"),
    createString("Status"),
    createString("Protocol"),
    createString("Accept"),
    createString("Accept Charset"),
    createString("Accept Datetime"),
    createString("Accept Encoding"),
    createString("Accept Language"),
    createString("Accept Ranges"),
    ...
    createString("Age"),
    createString("Allow"),
    createString("Alt Svc"),
    createString("Authorization"),
    createString("Cache Control"),
    createString("Connection"),
    createString("Content Disposition"),
    createString("Content Encoding"),
    createString("Content Language"),
    createString("Content Length"),
    createString("Content Location"),
    createString("Content MD5"),
    createString("Content Range"),
    createString("Content Type"),
    createString("Cookie"),
    createString("DNT"),
    createString("Date"),
    createString("ETag"),
    createString("Expect"),
    createString("Expires"),
    createString("From"),
    createString("Front End Https"),
    createString("Host"),
    createString("If Match"),
    createString("If Modified Since"),
    createString("If None Match"),
    createString("If Range"),
    createString("If Unmodified Since"),
    createString("Keep Alive"),
    createString("Last Modified"),
    createString("Link"),
    createString("Location"),
    createString("Max Forwards"),
    createString("Origin"),
    createString("P3P"),
    createString("Pragma"),
    createString("Proxy Authenticate"),
    createString("Proxy Authorization"),
    createString("Proxy Connection"),
    createString("Range"),
    createString("Referer"),
    createString("Refresh"),
    createString("Retry After"),
    createString("Sec WebSocket Key"),
    createString("Sec WebSocket Accept"),
    createString("Server"),
    createString("Set Cookie"),
    createString("Sec Token Binding"),
    createString("Strict Transport Security"),
    createString("TE"),
    createString("Timestamp"),
    createString("Trailer"),
    createString("Transfer Encoding"),
    createString("Upgrade"),
    createString("User Agent"),
    createString("VIP"),
    createString("Vary"),
    createString("Via"),
    createString("WWW Authenticate"),
    createString("Warning"),
    createString("X Accel Redirect"),
    createString("X Content Security Policy Report Only"),
    createString("X Content Type Options"),
    createString("X Forwarded For"),
    createString("X Forwarded Proto"),
    createString("X Frame Options"),
    createString("X Powered By"),
    createString("X Real IP"),
    createString("X Requested With"),
    createString("X Thrift Protocol"),
    createString("X UA Compatible"),
    createString("X Wap Profile"),
    createString("X XSS Protection"),
    createString("Sec WebSocket Version"),
    createString("Sec WebSocket Extensions"),
    createString("Sec WebSocket Origin"),
    createString("Sec WebSocket Key1"),
    createString("Sec WebSocket Key2"),
    createString("Sec WebSocket Key3"),
    createString("Sec WebSocket Protocol"),
};

String _HttpHeaderParser::parseHttpHeader(int header) {
