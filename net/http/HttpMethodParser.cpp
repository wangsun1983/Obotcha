...
String _HttpMethodParser::doParse(int method) {
    ...
    case st(HttpMethod)::Delete:
        return st(HttpMethod)::DeleteString;
    case st(HttpMethod)::Get:
        return st(HttpMethod)::GetString;
    case st(HttpMethod)::Head:
        return st(HttpMethod)::HeadString;
    case st(HttpMethod)::Post:
        return st(HttpMethod)::PostString;
    case st(HttpMethod)::Put:
        return st(HttpMethod)::PutString;
    case st(HttpMethod)::Connect:
        return st(HttpMethod)::ConnectString;
    case st(HttpMethod)::Options:
        return st(HttpMethod)::OptionsString;
    case st(HttpMethod)::Trace:
        return st(HttpMethod)::TraceString;
    case st(HttpMethod)::Copy:
        return st(HttpMethod)::CopyString;
    case st(HttpMethod)::Lock:
        return st(HttpMethod)::LockString;
    case st(HttpMethod)::Mkcol:
        return st(HttpMethod)::MkcolString;
    case st(HttpMethod)::Move:
        return st(HttpMethod)::MoveString;
    case st(HttpMethod)::PropFind:
        return st(HttpMethod)::PropFindString;
    case st(HttpMethod)::PropPatch:
        return st(HttpMethod)::PropPatchString;
    case st(HttpMethod)::Unlock:
        return st(HttpMethod)::UnlockString;
    case st(HttpMethod)::Report:
        return st(HttpMethod)::ReportString;
    case st(HttpMethod)::MkActivity:
        return st(HttpMethod)::MkActivityString;
    case st(HttpMethod)::Checkout:
        return st(HttpMethod)::CheckoutString;
    case st(HttpMethod)::Merge:
        return st(HttpMethod)::MergeString;
    case st(HttpMethod)::Msearch:
        return st(HttpMethod)::MsearchString;
    case st(HttpMethod)::Notify:
        return st(HttpMethod)::NotifyString;
    case st(HttpMethod)::Subscribe:
        return st(HttpMethod)::SubscribeString;
    case st(HttpMethod)::UnSubscribe:
        return st(HttpMethod)::UnSubscribeString;
    case st(HttpMethod)::Patch:
        return st(HttpMethod)::PatchString;
    case st(HttpMethod)::Purge:
        return st(HttpMethod)::PurgeString;
    case st(HttpMethod)::Link:
        return st(HttpMethod)::LinkString;
    case st(HttpMethod)::Search:
        return st(HttpMethod)::SearchString;
    case st(HttpMethod)::Unlink:
        return st(HttpMethod)::UnlinkString;
    case st(HttpMethod)::Source:
        return st(HttpMethod)::SourceString;
    }
